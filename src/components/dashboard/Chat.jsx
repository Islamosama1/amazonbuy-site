  ...
  useEffect(() => {
    if (receverMessage) {
      if (
        ...
        toast.success(receverMessage.senderName + " " + "أرسل رسالة إلى");
        dispatch(messageClear());
      }
    }
  }, [receverMessage]);
        ...
        <div className="w-[calc(100%-230px)] md-lg:w-full">
          {currentFd ? (
            <div className="w-full h-full">
              ...
              <div className="h-[400px] w-full bg-slate-100 p-3 rounded-md" dir="ltr">
                      ...
                      return (
                        ...
                        >
                          <img
                            ...
                            src="https://www.amazonbuy.site/images/user.png"
                            alt=""
                          />
              ...
              <div className="flex p-2 justify-between items-center w-full" dir="ltr">
            ...
            >
              <span>اختر البائع من القائمة علي يمينك</span>
            </div>
          )}
        </div>
      </div>
