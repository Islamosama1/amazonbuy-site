...
<table className='w-full text-sm text-left text-gray-500'>
    <thead className='text-xs text-gray-700 uppercase bg-gray-200'>
        <tr>
            <th scope='col' className='px-6 py-3'>معرف الطلب</th>
            <th scope='col' className='px-6 py-3'>سعر</th>
            <th scope='col' className='px-6 py-3'>حالة الدفع</th>
            <th scope='col' className='px-6 py-3'>حالة الطلب</th>
            <th scope='col' className='px-6 py-3'>تصرف</th> 
        </tr>
    </thead>
        <tbody>
        {
