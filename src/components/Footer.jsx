  ...
  return (
    <footer className="bg-[#f3f6fa]">
      {/* <div className="w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6">
        ...
        <div className="w-5/12 lg:w-8/12 sm:w-full" dir="rtl">
          <div className="flex justify-center sm:justify-start sm:mt-6 w-full">
            <div>
              <h2 className="font-bold text-lg mb-2">روابط مفيدة </h2>
              <div className="flex justify-between gap-[80px] lg:gap-[40px]">
                <ul className="flex flex-col gap-2 text-slate-600 text-sm font-semibold">
                  ...
                  <li>
                    <Link>نبذة عن متجرنا </Link>
                  </li>
                  <li>
                    <Link>معلومات التسليم </Link>
                  </li>
                  <li>
        ...
        <div className="w-4/12 lg:w-full lg:mt-6">
          <div className="w-full flex flex-col justify-start gap-5">
            <h2 className="font-bold text-lg mb-2">تابع اخر التحديثات</h2>
            <span>
              احصل على تحديثات البريد الإلكتروني حول أحدث الجولات والعروض الخاصة
              بالتسوق
            </span>
