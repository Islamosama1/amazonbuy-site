              ...
              <div className="w-[33%] md-lg:w-full">
                <div className="pr-3 md-lg:pr-0 md-lg:mt-5">
                  {card_products.length > 0 && (
                    <div className="bg-white p-3 text-slate-600 flex flex-col gap-3" dir="rtl">
                      <h2 className="text-xl font-bold">ملخص ما سيتم دفعه للبائع</h2>
                      ...
                      >
                        تواصل مع البائع عن طريق الموقع ({buy_product_item})
                      </button>
                    </div>
                  )}
                </div>
