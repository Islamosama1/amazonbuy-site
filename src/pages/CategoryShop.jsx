    ...
    return (
        <div>
           ...
           <section className='bg-[url("https://www.amazonbuy.site/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                ...
                <h2 className='text-3xl font-bold'>صفحة الفئة </h2>
        ...
        <div className='py-2 flex flex-col gap-5'>
            <h2 className='text-3xl font-bold mb-3 text-slate-600'>Price</h2>
             ...
             />  
         <div>
         <span className='text-slate-800 font-bold text-lg'>ج.م.{Math.floor(state.values[0])} - ج.م.{Math.floor(state.values[1])}</span>  
           </div>
         </div>

         <div className='py-3 flex flex-col gap-4'>
            <h2 className='text-3xl font-bold mb-3 text-slate-600'>التقييمات </h2>
        ...
        <div className='flex justify-center items-center gap-3'>
            <select onChange={(e)=>setSortPrice(e.target.value)} className='p-1 border outline-0 text-slate-600 font-semibold' name="" id="">
                ...
                <option value="low-to-high">السعر من المنخفض إلى المرتفع</option>
                <option value="high-to-low">السعر من المرتفع إلى المنخفض </option>
            </select>
