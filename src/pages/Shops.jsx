        ...
        <div className="absolute left-0 top-0 w-full h-full bg-[#2422228a]">
          <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <div className="flex flex-col justify-center gap-1 items-center h-full w-full text-white">
              <h2 className="text-3xl font-bold">صفحة الاعلانات </h2>
              <div className="flex justify-center items-center gap-2 text-2xl w-full">
                <Link to="/">الرئيسية</Link>
                <span className="pt-1">
                  <IoIosArrowForward />
                </span>
                <span>كل الاعلانات </span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          ...
          <div className="w-full flex flex-wrap">
            ...
            >
              <h2 className="text-3xl font-bold mb-3 text-slate-600" dir="rtl">الفئات </h2>
              ...
              <div className="py-2 flex flex-col gap-5">
                <h2 className="text-3xl font-bold mb-3 text-slate-600" dir="rtl">السعر</h2>
                ...
                <div dir="rtl">
                  <span className="text-slate-800 font-bold text-lg">
                    {Math.floor(state.values[0])}ج.م. -  
                    {Math.floor(state.values[1])}ج.م.
                  </span>
                </div>
              </div>

              <div className="py-3 flex flex-col gap-4" dir="rtl">
              ...
              <div className="py-5 flex flex-col gap-4 md:hidden">
                <Products title="أحدث الاعلانات" products={latest_product} />
              </div>
            </div>
