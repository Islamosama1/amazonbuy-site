...
const Details = () => {
  ...
  return (
    <div>
        ...
        <div className="absolute left-0 top-0 w-full h-full bg-[#2422228a]">
          <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
            <div className="flex flex-col justify-center gap-1 items-center h-full w-full text-white">
              <h2 className="text-3xl font-bold">تفاصيل المنتج </h2>
                ...
                {product.stock ? (
                  <>
                    ...
                    <div>
                      <button
                        onClick={add_card}
                        className="px-8 py-3 h-fit cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#059473] text-white"
                      >
                        اضف الى السلة
                      </button>
                    </div>
              ...
              <div className="flex gap-3">
                {product.stock ? (
                  <Link
                    ...
                    to={`https://wa.me/+2${product.brand}`}
                    className="px-8 py-3 cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#247462] text-white h-fit"
                  >
                ...
                <Link
                  ...
                  className="px-8 py-3 cursor-pointer hover:shadow-lg hover:shadow-red-500/40 bg-red-500 text-white rounded-sm h-fit"
                >
            ...
            <div className="w-[28%] md-lg:w-full">
              <div className="pl-4 md-lg:pl-0">
                <div className="px-3 py-2 text-slate-600 bg-slate-200">
                  <h2 className="font-bold">من {product.shopName}</h2>
                </div>
      ...
      <section>
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          <h2 className="text-2xl py-8 text-slate-600">المنتجات ذات الصلة </h2>
          <div>
            <Swiper
              slidesPerView="auto"
              breakpoints={{
