        ...
        <div>
          ...
          <section className='bg-[url("http://localhost:3000/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                ...
                <h2 className='text-3xl font-bold'>صفحة الشحن </h2>
        ...
        <div className='w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90%] mx-auto py-16'>
           <div className='w-full flex flex-wrap'>
            <div className='w-[67%] md-lg:w-full'>
                <div className='flex flex-col gap-3'>
                    <div className='bg-white p-6 shadow-sm rounded-md'>
                        ...
                        <h2 className='text-slate-600 font-bold pb-3'>معلومات الشحن </h2>
...

            {
                ...
                <h2 className='text-slate-600 font-semibold pb-2'>تسليم إلى {state.name}</h2>
                <p>
                    <span className='bg-blue-200 text-blue-800 text-sm font-medium mr-2 px-2 py-1 rounded'>بيت</span>
                    <span>{state.phone} {state.address} {state.province} {state.city} {state.area}  </span>

                    <span onClick={() => setRes(false)} className='text-indigo-500 cursor-pointer'>تغيير </span>
                </p>

                <p className='text-slate-600 text-sm' >البريد الإلكتروني إلى ariyan@gmail.com</p>
    ...
    <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
            ...
            <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <span>ج.م.{price + shipping_fee} </span>
                </div>
